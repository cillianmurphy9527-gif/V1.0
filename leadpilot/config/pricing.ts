...
// ══════════════════════════════════════════════════
// 0. 发信域名分级配置 (Domain Tiers) - 核心风控防线
// ══════════════════════════════════════════════════

export const TLD_TIERS = {
  GOLD: {
    suffixes: ['.com', '.net', '.co', '.org'],
    label: '黄金级权威后缀',
    price: 159,
    warmupSpeed: 'fast' // 快速预热通道
  },
  SILVER: {
    suffixes: ['.online', '.site', '.store', '.website', '.tech'],
    label: '白银级性价比后缀',
    price: 99,
    warmupSpeed: 'standard' // 标准预热通道
  },
  TOXIC: {
    suffixes: ['.xyz', '.pw', '.top', '.icu', '.click', '.cheap'],
    label: '剧毒黑名单后缀' // 前后端强拦截，禁止购买
  }
}
...
export interface Plan {
  ...
  domainTier: 'SILVER' | 'GOLD' // 注入域名等级识别符
  domainCount: number           // 赠送域名数量
  quotas: {
...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { label: '发信域名池',     value: '包含 1 个白银级发信域名 (价值¥99)', highlight: true }, // 更新文案
  ...
  },
  {
    ...
    features: [
      ...
      { label: '发信域名池',     value: '包含 1 个黄金级权威域名 (价值¥159)', highlight: true }, // 更新文案
  ...
  },
  {
    ...
    features: [
      ...
      { label: '发信域名池',     value: '包含 2 个黄金级权威域名 (价值¥318)', highlight: true }, // 更新文案
...
export interface DomainAddon {
  ...
  icon: LucideIconName
  badge?: string
  domainTier: 'SILVER' | 'GOLD' // 标记域名包的等级
  domainCount: number
  validDays: number 
}
...
export const DOMAIN_ADDONS: DomainAddon[] = [
  // ─── 白银级矩阵 (SILVER TIERS) ───
  {
    id: 'domain-silver-1',
    name: '白银级发信域名包 · 1个',
    shortDesc: '包含 .online/.site 等性价比后缀，需标准预热',
    price: 99,
    icon: 'Globe',
    domainTier: 'SILVER',
    domainCount: 1,
    validDays: -1,
    modalDetail: `【商品规格】\n• 增加 1 个白银级发信域名额度\n• 永久有效，系统自动解析与绑定配置\n• 支持后缀：.online, .site, .store, .website, .tech\n\n【优势与场景】\n• 极具性价比，适合中小团队铺设发信矩阵\n• 独立发信池，彻底隔离风险，防止主站受牵连\n• 系统内置“标准预热机制”，14天跑通进箱率\n\n【自动部署机制】\n• 支付后，输入想要的品牌名，系统全自动购买解析\n• 全程 0 代码操作\n\n【注意事项】\n• 该等级不支持选购 .com 等黄金级后缀\n• 域名资产一经购买成功，不可退换与转让`,
  },
  {
    id: 'domain-silver-3',
    name: '白银级发信域名包 · 3个',
    shortDesc: '阶梯立减 ¥48，中小团队首选发信矩阵',
    price: 249,
    icon: 'Globe',
    badge: '性价比首选',
    domainTier: 'SILVER',
    domainCount: 3,
    validDays: -1,
    modalDetail: `【商品规格】\n• 增加 3 个白银级发信域名额度\n• 永久有效，系统自动解析与绑定配置\n• 支持后缀：.online, .site, .store, .website, .tech\n• 阶梯特惠：单买 ¥99/个，组合包仅需 ¥83/个！\n\n【优势与场景】\n• 通过多域名轮换，将每天发信量安全拉升至上千封\n• 极具性价比，适合想要快速铺量的出海团队\n\n【自动部署机制】\n• 支付后，输入想要的品牌名，系统全自动购买解析\n• 全程 0 代码操作\n\n【注意事项】\n• 该等级不支持选购 .com 等黄金级后缀\n• 域名资产一经购买成功，不可退换与转让`,
  },
  {
    id: 'domain-silver-5',
    name: '白银级发信域名包 · 5个',
    shortDesc: '阶梯立减 ¥96，大批量冷邮件轰炸必备',
    price: 399,
    icon: 'Globe',
    badge: '批量铺设',
    domainTier: 'SILVER',
    domainCount: 5,
    validDays: -1,
    modalDetail: `【商品规格】\n• 增加 5 个白银级发信域名额度\n• 永久有效，系统自动解析与绑定配置\n• 支持后缀：.online, .site, .store, .website, .tech\n• 阶梯特惠：单买 ¥99/个，组合包仅需 ¥79.8/个！\n\n【优势与场景】\n• 暴力铺设冷邮件矩阵的终极性价比方案\n• 5个独立域名轮换，轻松承载每日几千封的超高并发\n\n【自动部署机制】\n• 支付后，输入想要的品牌名，系统全自动购买解析\n• 全程 0 代码操作\n\n【注意事项】\n• 该等级不支持选购 .com 等黄金级后缀\n• 域名资产一经购买成功，不可退换与转让`,
  },
  ...
  // ─── 黄金级矩阵 (GOLD TIERS) ───
  {
    id: 'domain-gold-1',
    name: '黄金级权威域名包 · 1个',
    shortDesc: '包含 .com/.net 等顶级后缀，急速预热极高进箱',
    price: 159,
    icon: 'Globe',
    domainTier: 'GOLD',
    domainCount: 1,
    validDays: -1,
    modalDetail: `【商品规格】\n• 增加 1 个黄金级权威发信域名额度\n• 永久有效，系统自动解析与绑定配置\n• 支持顶级后缀：.com, .net, .co, .org\n\n【优势与场景】\n• 顶级反垃圾邮件信任背书，专攻挑剔的海外大中型企业客户\n• 系统内置“急速预热通道”，7天即可进入高效发信期\n• 进箱率实测比普通后缀高 35% 以上\n\n【自动部署机制】\n• 支付后，输入想要的品牌名，系统全自动购买解析\n• 全程 0 代码操作\n\n【注意事项】\n• 域名资产一经购买成功，不可退换与转让`,
  },
  {
    id: 'domain-gold-3',
    name: '黄金级权威域名包 · 3个',
    shortDesc: '阶梯立减 ¥78，企业级高进箱率推荐配置',
    price: 399,
    icon: 'Globe',
    badge: '进箱神器',
    domainTier: 'GOLD',
    domainCount: 3,
    validDays: -1,
    modalDetail: `【商品规格】\n• 增加 3 个黄金级权威发信域名额度\n• 永久有效，系统自动解析与绑定配置\n• 支持顶级后缀：.com, .net, .co, .org\n• 阶梯特惠：单买 ¥159/个，组合包仅需 ¥133/个！\n\n【优势与场景】\n• 为出海企业打造高进箱、高并发的黄金发信矩阵\n• 各个业务线独立分配 .com 黄金通道，防封且极度专业\n• 高客单价 B2B 业务必备\n\n【自动部署机制】\n• 支付后，输入想要的品牌名，系统全自动购买解析\n• 全程 0 代码操作\n\n【注意事项】\n• 域名资产一经购买成功，不可退换与转让`,
  },
  {
    id: 'domain-gold-5',
    name: '黄金级权威域名包 · 5个',
    shortDesc: '阶梯立减 ¥196，终极抗封杀顶级域名集群',
    price: 599,
    icon: 'Globe',
    badge: '顶级矩阵',
    domainTier: 'GOLD',
    domainCount: 5,
    validDays: -1,
    modalDetail: `【商品规格】\n• 增加 5 个黄金级权威发信域名额度\n• 永久有效，系统自动解析与绑定配置\n• 支持顶级后缀：.com, .net, .co, .org\n• 阶梯特惠：单买 ¥159/个，组合包仅需 ¥119.8/个！\n\n【优势与场景】\n• 这是目前防风控、抗封杀、保送箱率的最高配置\n• 5 个顶级 .com 域名互相轮换掩护，轻松越过 Outlook/Google 严苛拦截\n• 适合需要海量、持续、稳定获客的头部玩家\n\n【自动部署机制】\n• 支付后，输入想要的品牌名，系统全自动购买解析\n• 全程 0 代码操作\n\n【注意事项】\n• 域名资产一经购买成功，不可退换与转让`,
  },
]
